...
if not (UPSTREAM / "@Resources").exists():
    # In this fork the original Rainmeter files live at the repository root,
    # while this Linux port lives under ports/linux-driftwm.
